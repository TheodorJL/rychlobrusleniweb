...
function csr_settings_registry() {
	...
	$sections['hero'] = array(
		...
		'fields' => array(
			...
			'csr_hero_line1' => array( 'type' => 'text', 'label' => 'Nadpis — 1. řádek, začátek', 'default' => 'Rychlost' ),
			'csr_hero_line2' => array( 'type' => 'text', 'label' => 'Nadpis — 1. řádek, pokračování', 'desc' => 'Stojí na stejném řádku jako začátek.', 'default' => 'má' ),
			'csr_hero_line3' => array(
				'type'    => 'text',
				'label'   => 'Nadpis — 2. řádek (barevný)',
